		...
		<div class="wrapper">
			...
			<div class="tab-content">
				<div id="dashboard" class="tab-pane fade in active col-sm-12">
					<div class="col-sm-1 addpaddingtop">
						<nav class="nav flex-column">
							<a class="nav-link active" data-toggle="tab" href="#chartsad">Active Directory Graphs</a><br><br>
							<a class="nav-link" data-toggle="tab" href="#chartsfs">File System Graphs</a><br><br>
							<a class="nav-link" data-toggle="tab" href="#chartsauth">Authentication Graphs</a><br><br>
							<a class="nav-link" data-toggle="tab" href="#chartsgpo">Group Policy Graphs</a><br><br>
							<a class="nav-link" data-toggle="tab" href="#summaryreport">Summary</a><br><br>
						</nav>
					</div>
					<div class="tab-content">
						<div id="chartsad" class="form-group row marginleft tab-pane fade in active">
						...
						<div id="chartsfs" class="form-group row marginleft tab-pane fade">
						...
						<div id="chartsauth" class="form-group row marginleft tab-pane fade">
							<div class="addpaddingleft addpaddingtop chartsize col-sm-1">
						...
						<div id="chartsgpo" class="form-group row marginleft tab-pane fade">
							<div class="addpaddingleft addpaddingtop chartsize col-sm-1">
						...
						<div id="summaryreport" class="container marginleft addpaddingtop tab-pane fade">
							<table class="table table-hover table-striped table-sm">
								<th class="sumtableheader" colspan="3">User Logon Summary Last 30 Days</th>
								<tr>
								...
								<tr>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Failed+Authentication+Activity+Last+30+Days&table=Logon_Logoff_and_Failed_Logon_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=failed&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=%24&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=FailCodeText&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=FromServer">Failures: <?php echo $sumQueryTotalFailsResults[0][0] ?></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=<?php echo $llHBarQueryResults[0][0] ?>+Logon+Failures+Last+30+Days&table=Logon_Logoff_and_Failed_Logon_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=%24&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=fail&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=<?php echo $llHBarQueryResults[0][0] ?>&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=FailCodeText&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=FromServer"><?php echo $llHBarQueryResults[0][0] ?> (<?php echo $llHBarQueryResults[0][1] ?>)</a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=<?php echo $barAuthsResults[0][0] ?>+Successful+Authentications+Last+30+Days&table=Logon_Logoff_and_Failed_Logon_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=%24&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=failed&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=logoff&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=<?php echo $barAuthsResults[0][0] ?>&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=FailCodeText&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=FromServer"><?php echo $barAuthsResults[0][0] ?> (<?php echo $barAuthsResults[0][1] ?>)</a></td>
								</tr>
								<tr>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Successful+Authentication+Activity+Last+30+Days&table=Logon_Logoff_and_Failed_Logon_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=%24&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=failed&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=logoff&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=FailCodeText&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=FromServer">Success: <?php echo $sumQueryTotalSuccResults[0][0] ?></a></td>
									...
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=<?php echo $barAuthsResults[1][0] ?>+Successful+Authentications+Last+30+Days&table=Logon_Logoff_and_Failed_Logon_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=%24&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=failed&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=logoff&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=<?php echo $barAuthsResults[1][0] ?>&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=FailCodeText&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=FromServer"><?php echo $barAuthsResults[1][0] ?> (<?php echo $barAuthsResults[1][1] ?>)</a></td>
								</tr>
								<tr>
									<td></td>
									...
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=<?php echo $barAuthsResults[2][0] ?>+Successful+Authentications+Last+30+Days&table=Logon_Logoff_and_Failed_Logon_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=%24&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=failed&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=logoff&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=<?php echo $barAuthsResults[2][0] ?>&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=FailCodeText&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=FromServer"><?php echo $barAuthsResults[2][0] ?> (<?php echo $barAuthsResults[2][1] ?>)</a></td>
								</tr>
								<tr>
									<td></td>
									...
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=<?php echo $barAuthsResults[3][0] ?>+Successful+Authentications+Last+30+Days&table=Logon_Logoff_and_Failed_Logon_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=%24&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=failed&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=logoff&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=<?php echo $barAuthsResults[3][0] ?>&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=FailCodeText&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=FromServer"><?php echo $barAuthsResults[3][0] ?> (<?php echo $barAuthsResults[3][1] ?>)</a></td>
								</tr>
								<tr>
									<td></td>
									...
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=<?php echo $barAuthsResults[4][0] ?>+Successful+Authentications+Last+30+Days&table=Logon_Logoff_and_Failed_Logon_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=%24&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=failed&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=logoff&filtercolumns%5B%5D=UserName&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=<?php echo $barAuthsResults[4][0] ?>&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=FailCodeText&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=FromServer"><?php echo $barAuthsResults[4][0] ?> (<?php echo $barAuthsResults[4][1] ?>)</a></td>
								</tr>
							</table>
							<table class="table table-hover table-striped table-sm">
								<th class="sumtableheader" colspan="3">User Status Summary Last 30 Days</th>
								<tr>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=User+Accounts+Created+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=User+Accounts+Created&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">User Creation: <?php echo $adHBarQueryCreatedResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=User+Accounts+Deleted+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=User+Accounts+Deleted&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">User Deletion: <?php echo $adHBarQueryDeletedResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=User+Account+Modifications+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=ObjectClass&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=user&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=object&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">User Modification: <?php echo $sumUserModsResults[0][0] ?></a></td>
								</tr>
								<tr>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=User+Accounts+Enabled+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=User+Accounts+Enabled&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">User Enabled: <?php echo $adHBarQueryEnabledResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=User+Accounts+Disabled+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=User+Accounts+Disabled&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">User Disabled: <?php echo $adHBarQueryDisabledResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=User+Account+Password+Reset+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=AttributeAffected&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=pwdlastset&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=ad+add+attribute&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">User Password Reset: <?php echo $sumPwdLastSetResults[0][0] ?></a></td>
								</tr>
								<tr>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=User+Accounts+Locked+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=add+attribute&filtercolumns%5B%5D=AttributeAffected&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=lockout&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">User Locked Out: <?php echo $adHBarQueryLockedResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=User+Accounts+Unlocked+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=delete+attribute&filtercolumns%5B%5D=AttributeAffected&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=lockout&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">User Unlocked: <?php echo $sumUnlockedResults[0][0] ?></a></td>
									<td></td>
								</tr>
							</table>
							<table class="table table-hover table-striped table-sm">
								<th class="sumtableheader" colspan="4">Group Status Summary Last 30 Days</th>
								<tr>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=Group+Creations+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=Groups+Created&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">Group Creation: <?php echo $adPieQueryGroupCreatesResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=Group+Deletions+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=Groups+Deleted&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">Group Deletion: <?php echo $adPieQueryGroupDeletesResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Users+Added+to+Groups+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=ad+add+attribute&filtercolumns%5B%5D=ObjectClass&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=group&filtercolumns%5B%5D=AttributeAffected&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=member&filtercolumns%5B%5D=AttributeAffected&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=memberof&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">Member Added To Group: <?php echo $adPieQueryGroupMemAddResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Users+Removed+from+Groups+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=ObjectClass&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=group&filtercolumns%5B%5D=AttributeAffected&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=member&filtercolumns%5B%5D=AttributeAffected&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=memberof&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=ad+delete+attribute&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">Member Removed From Group: <?php echo $adPieQueryGroupMemRemResults[0][0] ?></a></td>
								</tr>
							</table>
							<table class="table table-hover table-striped table-sm">
								<th class="sumtableheader" colspan="3">Computer Status Summary Last 30 Days</th>
								<tr>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=Computer+Accounts+Created+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=Computer+Accounts+Created&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">Computer Creation: <?php echo $sumCompCreatedResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=Computer+Accounts+Deleted+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=Computer+Accounts+Deleted&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">Computer Deletion: <?php echo $sumCompDeletedResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Computer+Accounts+Modified+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=ObjectClass&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=computer&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=object&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">Computer Modification: <?php echo $sumCompModsResults[0][0] ?></a></td>
								</tr>
								<tr>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=Computer+Accounts+Enabled+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=Computer+Accounts+Enabled&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">Computer Enabled: <?php echo $sumCompEnabledResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=Computer+Accounts+Disabled+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&adreportname=Computer+Accounts+Disabled&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer&table=Active_Directory_Profiles">Computer Disabled: <?php echo $sumCompDisabledResults[0][0] ?></a></td>
									<td></td>
								</tr>
							</table>
							<table class="table table-hover table-striped table-sm">
								<th class="sumtableheader" colspan="3">OU Status Summary Last 30 Days</th>
								<tr>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Organizational+Units+Created+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=create+object&filtercolumns%5B%5D=ObjectClass&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=organization&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">OU Creation: <?php echo $sumOUCreatedResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Organizational+Units+Deleted+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=ObjectClass&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=organization&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=delete+object&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">OU Deletion: <?php echo $sumOUDeletedResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Organizational+Units+Modified+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=ObjectClass&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=organization&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=object&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">OU Modification: <?php echo $sumOUModsResults[0][0] ?></a></td>
								</tr>
							</table>
							<table class="table table-hover table-striped table-sm">
								<th class="sumtableheader" colspan="4">GPO Status Summary Last 30 Days</th>
								<tr>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Group+Policy+Objects+Created+Last+30+Days&table=GPO_Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=create+object&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=GPODisplayName&selectedcolumns%5B%5D=GPOADChangeDetails&selectedcolumns%5B%5D=FromServer">GPO Creation: <?php echo $sumGPOCreatedResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Group+Policy+Objects+Deleted+Last+30+Days&table=GPO_Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=delete+object&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=GPODisplayName&selectedcolumns%5B%5D=GPOADChangeDetails&selectedcolumns%5B%5D=FromServer">GPO Deletion: <?php echo $sumGPODeletedResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Group+Policy+Objects+Linked+Last+30+Days&table=Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=AttributeAffected&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=gplink&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ObjectAffected&selectedcolumns%5B%5D=ObjectClass&selectedcolumns%5B%5D=AttributeAffected&selectedcolumns%5B%5D=AttributeValueAdded&selectedcolumns%5B%5D=AttributeValueRemoved&selectedcolumns%5B%5D=AdditionalDetailRegardingSelectedAttributes&selectedcolumns%5B%5D=FromServer">GPO Link Changes: <?php echo $sumGPOLinksResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Group+Policy+Objects+Modified+Last+30+Days&table=GPO_Active_Directory_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=create+object&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=NOT+LIKE&filtervalues%5B%5D=delete+object&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=PerformedByUserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=GPODisplayName&selectedcolumns%5B%5D=GPOADChangeDetails&selectedcolumns%5B%5D=FromServer">GPO Modification: <?php echo $sumGPOModsResults[0][0] ?></a></td>
								</tr>
							</table>
							<table class="table table-hover table-striped table-sm">
								<th class="sumtableheader" colspan="3">File System Summary Last 30 Days</th>
								<tr>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=File+and+Folder+Creations+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&fsreportname=Created+Files+and+Folders&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ShareName&selectedcolumns%5B%5D=FullFilePath&selectedcolumns%5B%5D=FileNameOnly&selectedcolumns%5B%5D=NewPathName&selectedcolumns%5B%5D=FromServer&table=File_System_Profiles">File/Folder Creation: <?php echo $pieCreatesResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=File+and+Folder+Deletions+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&fsreportname=Deleted+Files+and+Folders&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ShareName&selectedcolumns%5B%5D=FullFilePath&selectedcolumns%5B%5D=FileNameOnly&selectedcolumns%5B%5D=NewPathName&selectedcolumns%5B%5D=FromServer&table=File_System_Profiles">File/Folder Deletion: <?php echo $pieDeletesResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/cannedresults.php?formSubmit=HTML&title=Permissions+Changes+Last+30+Days&dateradio=on&datefilter2=30&dateexpression=days&fsreportname=Permissions+Changes&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ShareName&selectedcolumns%5B%5D=FullFilePath&selectedcolumns%5B%5D=FileNameOnly&selectedcolumns%5B%5D=NewPathName&selectedcolumns%5B%5D=FromServer&table=File_System_Profiles">File/Folder ACL Changes: <?php echo $piePermsResults[0][0] ?></a></td>
								</tr>
								<tr>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=File+and+Folder+Writes+Last+30+Days&table=File_System_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=write&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ShareName&selectedcolumns%5B%5D=FullFilePath&selectedcolumns%5B%5D=FileNameOnly&selectedcolumns%5B%5D=NewPathName&selectedcolumns%5B%5D=FromServer">File/Folder Write: <?php echo $pieWritesResults[0][0] ?></a></td>
									<td><a target="_blank" href="./cptrax/php/results.php?formSubmit=HTML&title=Renames+%26+Moves+Last+30+Days&table=File_System_Profiles&dateradio=on&datefilter2=30&dateexpression=days&filtervalue=&filtercolumns%5B%5D=Action&filterexpressions%5B%5D=LIKE&filtervalues%5B%5D=rename&selectedcolumns%5B%5D=Action&selectedcolumns%5B%5D=TimeOccurred&selectedcolumns%5B%5D=UserName&selectedcolumns%5B%5D=IPv4From&selectedcolumns%5B%5D=ShareName&selectedcolumns%5B%5D=FullFilePath&selectedcolumns%5B%5D=FileNameOnly&selectedcolumns%5B%5D=NewPathName&selectedcolumns%5B%5D=FromServer">File/Folder Rename/Move: <?php echo $pieRenamesResults[0][0] ?></a></td>
									<td></td>
								</tr>
							</table>
						</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-4">
									<select class="form-control" id="table" name="table" onchange="buildFilterColumns(this);buildAvailableColumns(this);buildSelectedColumns(this);">
										...
										<option value="Logon_Logoff_and_Failed_Logon_Profiles">Authentication</option>
										<option value="File_System_Profiles">File System</option>
										<option value="Active_Directory_Profiles">Active Directory</option>
										<option value="GPO_Active_Directory_Profiles">GPO AD Changes</option>
										<option value="GPO_File_System_Profiles">GPO FS Changes</option>										
									</select>
								</div>
							</div>
							<div class="form-group row">
				...
				<div id="reports" class="tab-pane fade">
					<div class="col-sm-2">
						<nav class="nav flex-column addpaddingtop addpaddingbottom">
							<a class="nav-link active" data-toggle="tab" href="#activedirectory">Active Directory Reports</a><br><br>
							<a class="nav-link" data-toggle="tab" href="#filesystem">File System Reports</a><br><br>
							<a class="nav-link" data-toggle="tab" href="#authentication">Authentication Reports</a><br><br>
							<a class="nav-link" data-toggle="tab" href="#gpoad">GPO AD Reports</a><br><br>
							<a class="nav-link" data-toggle="tab" href="#gpofs">GPO FS Reports</a><br><br>
							<a class="nav-link" data-toggle="tab" ></a><br><br>
							<a class="nav-link" data-toggle="tab" ></a><br><br>
						</nav>
					</div>
					<div class="tab-content">
						<div id="activedirectory" class="marginleft addpaddingtop tab-pane fade in active">
						...
						<div id="filesystem" class="form-group row marginleft addpaddingtop tab-pane fade">
							<form class="form-horizontal" method="get" action="./cptrax/php/cannedresults.php">
								<div class="form-group row btn-group">
						...
						<div id="authentication" class="form-group row marginleft addpaddingtop tab-pane fade">
							<form class="form-horizontal" method="get" action="./cptrax/php/cannedresults.php">
								<div class="form-group row btn-group">
						...
						<div id="gpoad" class="form-group row marginleft addpaddingtop tab-pane fade">
							<form class="form-horizontal" method="get" action="./cptrax/php/cannedresults.php">
								<div class="form-group row btn-group">
						...
						<div id="gpofs" class="form-group row marginleft addpaddingtop tab-pane fade">
							<form class="form-horizontal" method="get" action="./cptrax/php/cannedresults.php">
								<div class="form-group row btn-group">
									...
									<input type="submit" class="btn btn-default" formtarget="_blank" name="formSubmitCSV" value="PDF" formaction="./cptrax/php/pdfoutput.php" onclick="selectAllOptionsgpofs()">
								</div>
								<div>
									<div class="form-group row col-sm-11">
										<label class="col-sm-1 col-form-label">Report Title:</label>
