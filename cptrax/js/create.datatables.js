			...
			var table = $('#myTable').DataTable( {
				...
				ajax: {
					...
					{ 
						...
						selcolumns: '<?php foreach ($selectColumns as $col) { $selColumns .= $col.","; } echo $selColumns; ?>',
						filcolumns: '<?php foreach ($filterColumns as $col) { $filColumns .= $col.","; } echo $filColumns; ?>',
						filexpressions: '<?php foreach ($filterExpressions as $col) { $filExpressions .= $col.","; } echo $filExpressions; ?>',
						filvalues: '<?php foreach ($filterValues as $col) { $filValues .= $col.","; } echo addslashes($filValues); ?>',
						cannedfilter: '<?php echo $title; ?>'
					},
				},
				<?php
				echo "columns: [";
