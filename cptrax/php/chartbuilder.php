<?php
	...
	$adHBarQueryCreated = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%create object%' AND ObjectClass like '%user%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$adHBarQueryDeleted = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%delete object%' AND ObjectClass like '%user%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$adHBarQueryDisabled = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%add attribute%' AND ObjectClass like '%user%' AND AdditionalDetailRegardingSelectedAttributes like '%disabled%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$adHBarQueryEnabled = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%delete attribute%' AND ObjectClass like '%user%' AND AdditionalDetailRegardingSelectedAttributes like '%disabled%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$adHBarQueryLocked = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%add attribute%' AND AttributeAffected like '%lockout%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$pieQueryWrites = "SELECT Count(Action) FROM dbo.File_System_Profiles WHERE Action like '%write%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$pieQueryRenames = "SELECT Count(Action) FROM dbo.File_System_Profiles WHERE Action like '%rename%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$pieQueryCreates = "SELECT Count(Action) FROM dbo.File_System_Profiles WHERE Action like '%create%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$pieQueryDeletes = "SELECT Count(Action) FROM dbo.File_System_Profiles WHERE Action like '%delete%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$pieQueryPerms = "SELECT Count(Action) FROM dbo.File_System_Profiles WHERE Action like '%acl%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	// Get extra data for summary report
	
	// Total Auth Failures/Successes Last 30 Days Summary Report
	
	$sumQueryTotalFails = "SELECT Count(UserName) FROM [dbo].[Logon_Logoff_and_Failed_Logon_Profiles] WHERE UserName not like '%$%' AND Action like '%failed%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryTotalSucc = "SELECT Count(UserName) FROM [dbo].[Logon_Logoff_and_Failed_Logon_Profiles] WHERE UserName not like '%$%' AND Action not like '%failed%' AND Action not like '%logoff%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	// Total User Status Changes Last 30 Days Summary Report
	
	$sumQueryUnlocked = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%delete attribute%' AND AttributeAffected like '%lockout%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryCompCreated = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%create object%' AND ObjectClass like '%computer%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryCompDeleted = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%delete object%' AND ObjectClass like '%computer%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryCompDisabled = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%add attribute%' AND ObjectClass like '%computer%' AND AdditionalDetailRegardingSelectedAttributes like '%disabled%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryCompEnabled = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%delete attribute%' AND ObjectClass like '%computer%' AND AdditionalDetailRegardingSelectedAttributes like '%disabled%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryOUCreated = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%create object%' AND ObjectClass like '%organization%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryOUDeleted = "SELECT Count(Action) FROM dbo.Active_Directory_Profiles WHERE Action like '%delete object%' AND ObjectClass like '%organization%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryGPOCreated = "SELECT Count(Action) FROM dbo.GPO_Active_Directory_Profiles WHERE Action like '%create object%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryGPODeleted = "SELECT Count(Action) FROM dbo.GPO_Active_Directory_Profiles WHERE Action like '%delete object%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryGPOMods = "SELECT Count(Action) FROM dbo.GPO_Active_Directory_Profiles WHERE Action not like '%delete object%' AND Action not like '%create object%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
	...
	$sumQueryGPOLinks = "SELECT Count(Action) FROM Active_Directory_Profiles WHERE AttributeAffected like '%gplink%' AND (TimeOccurred >= DATEADD(DAY,-30,GETDATE()) AND TimeOccurred <= DATEADD(DAY,0,GETDATE()))";
